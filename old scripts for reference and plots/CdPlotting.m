...
%{
C_D_clip = C_D(1:clip_index); 
C_L_clip = C_L(1:clip_index);
M1_clip = M1(1:clip_index);
Re_clip = Re(1:clip_index);
%}
...
set(gcf,'color','w');
for i = 1:2
    plot(Re_plot{i}, M_plot{i}(128:end));
    hold on; 
end
legend('\gamma = -1.4 C_D = 0.8', '\gamma = -1.4 C_D = 1.4');
